...
class TrainingPipeline:
    ...
    def start_model_trainer(self,data_transformation_artifact:DataTransformationArtifact)->ModelTrainerArtifact:
        try:
            logging.info(f"Entered start_model_trainer:{data_transformation_artifact}")
            ...
            logging.info(f"Initiate initiate_model_trainer inside start_model_trainer:{model_trainer}")
    ...
    def run_pipeline(self):
        try:
            ...
            logging.info("Starting data model trainer pipeline")
